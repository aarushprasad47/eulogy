...
import {
  ...
  ChevronRight, Calendar, GitCompare, Phone, MessageCircle,
} from "lucide-react";
...
export default function Home({
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      {/* ── Fixed flower background — scrolls with page ───────────────── */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 90% 75% at 52% 42%, transparent 25%, rgba(238,242,248,0.5) 55%, rgba(238,242,248,0.85) 80%, rgba(238,242,248,1) 100%)",
          }}
        />
      </div>

      {/* ── Hero ─────────────────────────────────────────────────────── */}
      <section className="relative px-6 pb-12 pt-14" style={{ zIndex: 1 }}>
            ...
            <div className="hidden lg:block animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <div
                style={{
                  ...
                  overflow: "hidden",
                  position: "relative",
                  boxShadow: "0 20px 60px -12px rgba(68,114,168,0.20)",
                }}
              >
                <Image
                  src="/flower.png"
      ...
      {/* ── Feature cards ─────────────────────────────────────────────── */}
      <section className="relative px-6 pb-14 pt-10" style={{ zIndex: 1 }}>
        <div className="mx-auto max-w-7xl grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { Icon: GitCompare, title: "Helpful Resources",     desc: "Find guidance, checklists, and support when you need it most.",                                    delay: "0.20s" },
      ...
      {/* ── Quote — free-floating card ────────────────────────────────── */}
      <section className="relative px-6 py-8" style={{ zIndex: 1 }}>
        <div
          className="mx-auto max-w-4xl animate-fade-up rounded-2xl px-10 py-8"
          style={{ background: "rgba(244,247,251,0.90)", border: "1px solid var(--border)", backdropFilter: "blur(8px)", animationDelay: "0.1s" }}
        >
      ...
      {/* ── How we collect data ──────────────────────────────────────── */}
      <section className="relative px-6 pb-14 pt-6" style={{ zIndex: 1 }}>
        <div className="mx-auto max-w-7xl grid gap-8 grid-cols-1 sm:grid-cols-3">
          {[
            ...
            <div key={title} className="flex items-start gap-4 animate-fade-up" style={{ animationDelay: "0.05s" }}>
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl" style={{ background: "var(--icon-bg)" }}>
                <Icon className="h-5 w-5" style={{ color: "var(--navy)" }} />
              </div>
              <div>
      ...
      {/* ── Search results ─────────────────────────────────────────────── */}
      <section
        className="relative px-6 pb-20 pt-4"
        style={{ zIndex: 1, background: "rgba(244,247,251,0.95)" }}
      >
        <div className="mx-auto max-w-7xl">
